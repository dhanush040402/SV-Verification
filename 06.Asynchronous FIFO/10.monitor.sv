class monitor #(parameter depth , data_width);
  ...
  function new (mailbox w_montosco , mailbox r_montosco , virtual variable.wm wm1 , virtual variable.rm rm1,event w_dr_done,event r_dr_done,event w_mo_done,event r_mo_done);
